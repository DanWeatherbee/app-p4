...
var resizePizzas = function(size) {
  ...
  // simplified repetitive code and multiple query's by creating var
  function changeSliderLabel(size) {
    var pizza_label = document.querySelector("#pizzaSize");
    switch(size) {
      case "1":
        pizza_label.innerHTML = "Small";
        return;
      case "2":
        pizza_label.innerHTML = "Medium";
        return;
      case "3":
        pizza_label.innerHTML = "Large";
        return;
      default:
...
// moved the line below out of the function
