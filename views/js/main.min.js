...
function changePizzaSizes(size){switch(size){case"1":newwidth=25;break;case"2":newwidth=33.3;break;case"3":newwidth=50;break;}
var randomPizzas=document.getElementsByClassName("randomPizzaContainer");for(var i=0;i<randomPizzas.length;i++){randomPizzas[i].style.width=newwidth+"%";}}
...
var items=document.querySelectorAll('.mover');function updatePositions(){frame++;window.performance.mark("mark_start_frame");var phase=[];var scroll=document.body.scrollTop
for(var i=0;i<5;i++){phase.push(Math.sin(scroll / 1250+i)*100);}
...
window.addEventListener('scroll',updatePositions);document.addEventListener('DOMContentLoaded',function(){updatePositions();});